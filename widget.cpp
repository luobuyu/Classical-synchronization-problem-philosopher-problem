    ...
    ui(new Ui::Widget)
{
    ...
    peoples[0] = new People(0, 265, 60, 0, this, this->sem, this->chopsticks);
    peoples[1] = new People(1, 540, 200, 72, this, this->sem, this->chopsticks);
    peoples[2] = new People(2, 480, 510, 144, this, this->sem, this->chopsticks);
    peoples[3] = new People(3, 165, 550, 216, this, this->sem, this->chopsticks);
    peoples[4] = new People(4, 40, 265, 288, this, this->sem, this->chopsticks);
